export default {
  ...
  hotspot_setup: {
    ...
    ble_error: {
      ...
      title_1:'Please read last page and make sure that bluetooth is opened'
    },
    ble_scan: {
      cancel: 'Cancel Scan',
    ...
    enable_location: {
      ...
      next_1: 'l know',
      next_2: 'l know',
      next_3: 'Scan my Hotspot',
      p_1: 'We’ll ask for permisson to access your phone’s location',
      p_2: 'Buildings and metals can hinder signal propagation',
      p_3: 'Intensiveness of hotspots too dense or scattered are bad for earning',
      p_4: 'Buildings can hinder signal propagation',
      c_2: 'Coship will never ask for your private key,and can only access your hotspot,not any other device on your network',
      c_3: 'Please view our troubleshooting guide at',
      c_4: 'or use the local diagnostic tool to view real-time info of hotspot',
      d_1: 'Use the included pin to press the bt button on the back of the hotspot,press and hold for 5 seconds',
      d_2: 'Make sure to turn on your phone bluetooth',
      subtitle:
        'We need to set a location for your Hotspot,We can use your phone to do this',
      title: 'Set Hotspot\nLocation',
      title_1: 'Diagnosis',
      title_2: 'Bluetooth',
      subtitle_1:'Place hotspot with an open view',
      subtitle_2:'Diagnostic helps Coship safely identify your hotspot issues',
      subtitle_3:'Use the included pin to press the bt button on the back of the hotspot,press and hold for 5 seconds'
    },
    external: {
      qrTitle: 'Scan QR Code',
      instuructions: 'Your instuructions here',
    ...
    progress: {
      ...
      title_1: 'This can take a few minutes so feel free to close this screen',
      title_2: 'REGISTERING Hotspots',
    },
    selection: {
  ...
  hotspots: {
    ...
    explorer_1: 'https://www.helio.com/faq',
    empty: {
  ...
  more: {
    sections: {
      app: {
        ...
        signOutWithLink: 'Login out',
        signWithLink: 'Login in',
        signOutAlert: {
