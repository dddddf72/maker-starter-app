...
const MoreScreen = () => {
  ...
  const renderSectionHeader = useCallback(
    ({ section: { title, icon } }) => (
      ...
      >
        {icon !== undefined && icon}
        <Text variant="body1" marginLeft="s" color="grey">
          {title}
        </Text>
      </Box>
    ),
  ...
  return (
    <SafeAreaBox backgroundColor="black" flex={1} edges={edges}>
      <Text variant="h3" marginVertical="m" paddingHorizontal="l" color="primaryBackground"  marginTop="l" marginBottom="none">
        {t('more.title')}
      </Text>
      {/* <Enable></Enable> */}
      <SectionList
