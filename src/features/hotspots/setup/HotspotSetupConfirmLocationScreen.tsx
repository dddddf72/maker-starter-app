...
const HotspotSetupConfirmLocationScreen = () => {
  ...
  return (
    <BackScreen onClose={handleClose}  backgroundColor="black">
      <ScrollView>
        <Box flex={1} justifyContent="center" paddingBottom="xxl">
          <Text variant="h1" marginBottom="l" maxFontSizeMultiplier={1} color="white">
          ...
          <Box backgroundColor="dark" height={1} />
          <Box
            flexDirection="row"
            justifyContent="space-between"
            marginTop={{ phone: 'm', smallPhone: 'xxs' }}
